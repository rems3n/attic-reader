...
export type TestSection = { id: string; title: string; passage_title?: string; passage?: string; passage_source?: { author?: string; work?: string; ref?: string } | null; passage_note?: string; items: Item[] };
