...
with sync_playwright() as p:
    ...
    page.goto(f"{FRONT}/learn/lesson/6.3?step=2")
    ...
    page.goto(f"{FRONT}/learn/lesson/6.3?step=5")
    page.screenshot(path=f"{SHOTS}/u6-grammar.png", full_page=True)
    page.goto(f"{FRONT}/learn/lesson/6.3?step=6")
    ...
    # reading gate
    page.goto(f"{FRONT}/learn/test/gate-1")
