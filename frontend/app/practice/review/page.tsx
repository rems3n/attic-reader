...
import styles from "../../progress/skills.module.css";
...
function Review() {
  ...
  return (
    <main className="shell lessonShell">
      <Crumbs items={[{ label: "Learn", href: "/learn" }, ...(mode.kind !== "weak" ? [{ label: "Skills", href: "/progress" }] : []), { label: mode.kind === "mistakes" ? "Mistakes" : "Review" }]} />
        ...
        {done !== null && (
          <div className="stepDone">
            ...
            <div className="stepNav">
              ...
              <Link href={mode.kind === "weak" ? "/learn" : "/progress"} className="secondary buttonLike">{mode.kind === "weak" ? "Course home" : "Skills"}</Link>
            </div>
          </div>
        )}
      </section>
