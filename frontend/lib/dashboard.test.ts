...
import { hasLearningProgress, weeklyMinutes, wordCounts } from "./dashboard";
describe("dashboard metrics", () => {
  it("counts words once and requires established recognition, not a first review", () => {
    const p = emptyProgress();
    p.cards = {
      "a:recognition": { ...newCard(0), updated: 1, interval: 8, reps: 3 },
      "a:production": { ...newCard(0), updated: 1, interval: 8, reps: 3 },
