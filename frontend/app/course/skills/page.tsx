  ...
  return (
    <main className="shell">
      ...
      <div className={styles.toolbar}>
        ...
        <Link href="/course/review?mode=mistakes" className={styles.mistakesLink}>Mistakes deck <strong>{mistakes}</strong></Link>
      </div>
  ...
  return (
    <div id="skill-detail" className={styles.detail} role="region" aria-label={skill.label}>
      ...
      <div className={styles.actions}>
        {d?.drillable && <Link href={`/course/review?skills=${encodeURIComponent(skill.id)}`} className="primary buttonLike">Practise</Link>}
